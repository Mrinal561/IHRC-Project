...
//                 path: '/custom-checklist',
//                 title: 'Custom Checklist',
//                 translateKey: 'nav.collapseMenu.collapse.item2',
//                 icon: '',
//                 type: NAV_ITEM_TYPE_ITEM,
//                 authority: [],
//                 subMenu: [],
...
//         if (alwaysVisibleItems.includes(filteredItem.title)) {
//             return filteredItem;
//         }

//         if (filteredItem.key === 'groupMenu.collapse') {
//             return isAdmin ? filteredItem : null;
//         }

//         const menuInfo = findMenuInModuleList(filteredItem.title, moduleList);
        
//         if (filteredItem.subMenu && filteredItem.subMenu.length > 0) {
//             const filteredSubMenu = filterNavigation(filteredItem.subMenu, moduleList, isAdmin)
//                 .filter(item => item !== null) as NavigationTree[];
            
//             if (filteredSubMenu.length > 0 || isAdmin) {
//                 return {
//                     ...filteredItem,
...
//         return menuInfo.access?.can_list === true ? filteredItem : null;
//     }).filter(item => item !== null) as NavigationTree[];
// };
...
//     useEffect(() => {
//         console.log('Filtered Admin Nav:', filteredAdminNav);
//         console.log('Filtered User Nav:', filteredUserNav);
//         console.log('Module Access:', moduleList);
//     }, [filteredAdminNav, filteredUserNav, moduleList]);

...
const BranchAgreementForm = () => {
    ...
    const [agreementDocument, setAgreementDocument] = useState<File | null>(
        null,
    )
    ...
    const handleFormSubmit = async (
        ...
        try {
            ...
            if (values.agreementDocument instanceof File) {
                base64Document = await convertFileToBase64(
            ...
            if (
                ...
                const errorMessage =
                    error.response?.data?.message ||
                    'Failed to create branch agreement'
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <AgreementTypeAutosuggest
                                    ...
                                    onChange={(value) =>
                                        setFieldValue('agreementType', value)
                                    }
                            ...
                            <div className="space-y-2">
                                <label htmlFor="agreementDocument">
                                    Agreement Document (PDF/Zip/Image, Max 20MB){' '}
                                    <span className="text-red-500">*</span>
                                </label>
                                <Input

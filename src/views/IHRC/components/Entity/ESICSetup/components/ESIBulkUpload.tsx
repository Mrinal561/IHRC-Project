...
const ESIBulkUpload: React.FC<LWFBulkUploadProps> = ({
    onUploadSuccess,
    companyId,
}) => {
    ...
    const handleDownload = async () => {
        try {
            const res = await httpClient.get(
                endpoints.esiSetup.downloadFormat(companyId),
                {
                    responseType: 'blob',
                },
            )
            ...
            link.href = url
            link.setAttribute('download', 'ESI_Setup_Template.xlsx')

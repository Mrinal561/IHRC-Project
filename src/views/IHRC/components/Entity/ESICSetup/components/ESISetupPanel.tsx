...
const ESISetupPanel = ({
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // 2. Process filename (critical fix)
            const cleanFilename = file.name.replace(/\.[^/.]+$/, ""); // Remove extension
            const normalizedFilename = cleanFilename.replace(/[^a-zA-Z0-9-]/g, "_"); // Sanitize
            ...
            // 4. Prepare payload matching Postman's structure exactly
            setFormData(prev => ({
                ...prev,
                certificate: {
                    data: base64String,
        ...
        try {
            ...
            console.log('Final payload being sent:', {
                ...
                certificate: data.certificate ? {
                    ...data.certificate,
                    data: data.certificate.data.substring(0, 20) + '...' // Log partial data
                } : null
            });
